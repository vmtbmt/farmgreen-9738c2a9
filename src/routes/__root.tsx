...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Ứng dụng quản lý khu vườn, ghi nhật ký hoạt động và thống kê nông trại." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Farm Green — Quản lý nông trại thông minh" },
      { name: "twitter:description", content: "Ứng dụng quản lý khu vườn, ghi nhật ký hoạt động và thống kê nông trại." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c8a484aa-af18-4b2b-a717-8b501efb3bf4" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/c8a484aa-af18-4b2b-a717-8b501efb3bf4" },
    ],
    links: [
